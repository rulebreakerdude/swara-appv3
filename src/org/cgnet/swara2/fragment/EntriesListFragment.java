...
import org.cgnet.swara2.adapter.EntriesCursorAdapter;
...
public class EntriesListFragment extends SwipeRefreshListFragment {
    ...
    private static String TAG = "EntriesListFragment";
    ...
    private int MY_PERMISSIONS_REQUEST_READ_STORAGE = 0;
...
/*            case R.id.menu_all_read: {
    ...
    private void refreshUI() {
        ...
        if (mUri != null && FeedDataContentProvider.URI_MATCHER.match(mUri) != FeedDataContentProvider.URI_BULTOO) {
            enableSwipe();
        } else {
            disableSwipe();
        }
